...
Aos.init({
  ...
  return (
    <div className="absolute top-[30%] right-[3%] w-full md:w-3/12 px-4 h-4/6 rounded-lg mt-1 " data-aos="fade-up"  data-aos-duration="1000">
      {!showOtpField ? (
        <form onSubmit={formik.handleSubmit} className="h-full">
          <div className="bg-white p-4 rounded-2xl">
            <label htmlFor="firstName" className="font-open_spaced text-lg block">
              First Name:
            </label>
            <input
              type="text"
          ...
          <div className="bg-white p-4 rounded-2xl">
            <label htmlFor="lastName" className="font-open_spaced text-lg block">
              Last Name:
            </label>
            <input
              type="text"
          ...
          <div className="bg-white p-4 rounded-2xl">
            <label className="font-open_sans inline-flex items-center">
              ...
              <span className="ml-2 font-open_spaced">
                I accept the{" "}
                <a
                  className="text-blue-800 hover:underline font-semibold font-open_spaced"
          ...
          <div className="mt-4">
            <button
              ...
              className={`w-full h-12 rounded-full border border-gray-600 transition-all duration-300 mt-6 font-open_spaced ${
                loading ? "bg-gray-400 cursor-not-allowed" : "bg-blue-800 text-white font-semibold text-2xl font-open_sans"
              }`}
              disabled={loading}
            >
